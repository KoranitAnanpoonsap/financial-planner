...
const FaqItem = ({ question }) => (
  <details className="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
    ...
    <p className="mt-2 text-gray-700 pl-4">
      ...
      การวางแผนเกษียณเป็นวิธีเก็บเงินที่ช่วยให้เรามีเงินพอใช้ในช่วงบั้นปลายชีวิตเมื่อไม่สามารถหารายได้จากการ ทำงานอีกแล้ว เพราะลาออกก่อนครบกำหนดเกษียณ (Early Retire) หรือเกษียณในกรณีอายุครบ 60 ปี
      โดยเงินเก็บที่ใช้สำหรับชีวิตหลังเกษียณ ควรครอบคลุมทุกค่าใช้จ่าย เช่น ค่าเล่าเรียนของบุตรหลาน หรือค่าใช้จ่ายเล็กๆ อย่างค่าน้ำมันรถยนต์, ค่าอาหารในแต่ละมื้อ เป็นต้น เพื่อมั่นใจได้ว่าแผนเกษียณ จะรัดกุมเพียงพอ จนไม่ต้องทำงานหาเงินเพิ่มในยามที่สุขภาพเริ่มทรุดโทรม <br></br>
      <br></br>
