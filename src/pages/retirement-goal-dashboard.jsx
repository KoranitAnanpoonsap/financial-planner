    ...
    const DashBoardRetirementMain = () => {
        return (
            <div className="text-3xl flex flex-col w-full items-center border-black border-2 rounded-2xl p-4">
                ...
                <div className="m-2">จำนวนเงินที่ต้องมีทั้งหมด ณ วันเกษียณ {formatNumber(retirementGoalAmount)} บาท</div>
                <img
                    className="my-2"
        ...
        return (
            <div className="text-xl flex flex-row w-full items-start justify-between border-black border-2 rounded-2xl p-4 gap-8">
                <div className="flex flex-col">
                    ...
                    <div className="m-2">
                        อายุปัจจุบัน: {clientCurrentAge} ปี
                    </div>
                    {/*<div className="m-2">ระยะเวลาเป้าหมาย: {Goal.goalPeriod} ปี</div>*/}
                    <div className="m-2">
                        อายุเกษียณ: {clientRetirementAge} ปี
                    </div>
                    <div className="m-2">
                        อายุยืน: {clientLifeExpectancy} ปี
                    </div>
                </div>
                <div className="flex h-full items-center">
                    <img className="w-60 rounded-xl" src="src/assets/dashboard_retirement_image.jpg" alt="Dashboard Retirement Image"/>
                </div>
            </div>
        )
    }
