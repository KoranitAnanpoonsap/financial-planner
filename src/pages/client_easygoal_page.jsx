        ...
        <main className="relative min-h-screen overflow-hidden font-ibm">
          ...
          >
            ...
            <InputField
              ...
              tooltip="ชื่อของเป้าหมายที่คุณต้องการบรรลุ เช่น ซื้อบ้าน, รถยนต์, เกษียณอายุ"
            />
            <InputField
              label="จำนวนเงิน (บาท)"
              value={targetAmount}
              setValue={setTargetAmount}
              tooltip="จำนวนเงินที่คุณต้องใช้เพื่อบรรลุเป้าหมายนี้"
            />
            <InputField
              label="ระยะเวลา (ปี)"
              value={timeFrame}
              setValue={setTimeFrame}
              tooltip="จำนวนปีที่คุณต้องการบรรลุเป้าหมายนี้"
            />
            <InputField
              label="เงินรวมปัจจุบันในการลงทุน (บาท)"
              value={currentSavings}
              setValue={setCurrentSavings}
              tooltip="จำนวนเงินที่คุณมีอยู่ในการลงทุนปัจจุบันเพื่อใช้สำหรับเป้าหมายนี้ เช่น เงินฝาก หรือ การลงทุนในสินทรัพย์อื่นๆ"
            />
            <InputField
              label="ผลตอบแทนต่อปีของการลงทุน (%)"
              value={expectedReturn}
              setValue={setExpectedReturn}
              tooltip="อัตราผลตอบแทนที่คุณคาดหวังจากการลงทุน"
            />
